 ...
 * @version    0.1.0
 * @link       https://github.com/codemasher/gw2-wvwstats/blob/master/classes/sql.class.php
 * @created    27.12.13
 *
...
class SQL extends mysqli{
	 ...
	 */
	public function Q($sql, $assoc = true){
	 ...
	 */
	private function get_references($arr){
		$references = [];
	 ...
	 */
	public function P($sql, array $values = [], $types = '', $assoc = true){
	 ...
	 */
	public function MI($sql, $values, $types = ''){
